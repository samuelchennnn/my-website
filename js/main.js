...
const i18n = {
  en: {
    ...
    nav_contact: 'Contact',
    hero_desc: 'Building at the intersection of technology, finance, and global markets. Computer Science student · GDSC · IELTS 8.0 · Based in Shenzhen.',
    ...
    exp_title: 'Timeline',
    exp_desc: 'Internships and research roles in investment, finance, and HR.',
    tl_0_title: 'Cross-border Projects & Global Exposure',
    tl_0_preview: 'Founded SZ-HK Premium Lecture & Event Sharing Community (~500 members). Commissioned to organize GBA × Johor-Singapore SEZ youth exchange. Completed SYSU Industrial Finance program.',
    tl_0_detail_label: 'Key Achievements',
    tl_0_d1: 'Founded SZ-HK Premium Lecture & Event Sharing Community — ~500 general members, ~100 premium users',
    tl_0_d2: 'Content partnerships with HKU Business School, PKU HSBC Business School, and Great Bay University',
    tl_0_d3: 'Commissioned by former Singaporean trade official for GBA × Johor-Singapore SEZ youth exchange',
    tl_0_d4: 'Completed SYSU-Shenzhen Advanced Research Program on Industrial Finance',
    tl_1_title: 'Executive Assistant to GM · 道深投资控股',
    tl_1_preview: 'Cross-border IPO advisory, executive-level liaison with Malaysian listed companies, roadshow strategy, and full-cycle client onboarding support.',
    tl_1_detail_label: 'Key Responsibilities',
    tl_1_d1: 'Cross-border IPO advisory for companies seeking dual listing between China and Malaysia',
    tl_1_d2: 'Executive-level liaison with Malaysian listed companies and regulatory bodies',
    tl_1_d3: 'Roadshow strategy development and investor presentation preparation',
    tl_1_d4: 'Full-cycle client onboarding — from initial contact to engagement letter',
    tl_2_title: 'Interviewed U.S. Treasury Secretary Bessent',
    tl_2_preview: 'On-site in Kuala Lumpur during U.S.-China trade talks. Captured and published exclusive footage and key diplomatic moments.',
    tl_2_detail_label: 'Details',
    tl_2_d1: "On-the-ground coverage of U.S.-China trade negotiations in Kuala Lumpur",
    tl_2_d2: "Captured exclusive footage of Secretary Bessent's remarks",
    tl_2_d3: 'Published content on Xiaohongshu, generating 100+ engagements',
    tl_2_d4: 'Demonstrated ability to operate in high-stakes diplomatic environments',
    ...
    tl_4_title: 'Investment Assistant · 海坤投资管理',
    tl_4_preview: 'Global market intelligence (Bloomberg/SCMP), AI/SaaS chuhai project screening, financial data analysis with Excel.',
    tl_4_detail_label: 'Key Responsibilities',
    tl_4_d1: 'Global market intelligence gathering via Bloomberg, SCMP, and financial databases',
    tl_4_d2: 'AI and SaaS chuhai project screening and preliminary due diligence',
    tl_4_d3: 'Financial data analysis and modeling using Excel',
    tl_4_d4: 'Investment memo preparation for the investment committee',
    tl_5_title: 'B.Sc. Computer Science',
    tl_5_preview: 'Top 20% of class. Key courses: Computer Organization, Software Engineering, Java, Operating Systems, Discrete Math. GDSC member.',
    tl_5_detail_label: 'Academic Highlights',
    tl_5_d1: 'Top 20% of Computer Science class',
    tl_5_d2: 'Key coursework: Computer Organization, Software Engineering, Java, Operating Systems, Discrete Mathematics',
    tl_5_d3: 'Google Developer Student Club (GDSC) member',
    tl_5_d4: 'IELTS Reading 8.0 — proficient in English academic and financial materials',
  ...
  zh: {
    ...
    nav_experience: '经历',
    nav_contact: '联系',
    hero_desc: '在科技、金融与全球市场的交汇处构建。计算机科学专业 · GDSC · IELTS 8.0 · 坐标深圳。',
    ...
    tl_0_title: '跨境项目与全球视野',
    tl_0_preview: '发起并运营深圳-香港高端讲座会议分享社群（约500人）。受委托组织大湾区 × 柔新经济特区青年交流。完成中山大学产业金融项目。',
    tl_0_detail_label: '关键成就',
    tl_0_d1: '发起并运营深圳-香港高端讲座会议分享社群 — 普通成员约500人，高端垂直用户约100人',
    tl_0_d2: '与香港大学商学院、北京大学汇丰商学院、大湾区大学等高校建立内容合作',
    tl_0_d3: '受新加坡前贸易官员委托，组织大湾区 × 柔新经济特区青年交流',
    tl_0_d4: '完成中山大学深圳研究院产业金融高级研修项目',
    tl_1_title: '总经理业务助理 · 道深投资控股',
    tl_1_preview: '跨境 IPO 咨询，与马来西亚上市公司高管层对接，路演策略制定，全周期客户入驻支持。',
    tl_1_detail_label: '主要职责',
    tl_1_d1: '为中马两地寻求双重上市的企业提供跨境 IPO 咨询',
    tl_1_d2: '与马来西亚上市公司及监管机构进行高管层对接',
    tl_1_d3: '路演策略制定与投资者演示材料准备',
    tl_1_d4: '全周期客户入驻 — 从初次接触到签约',
    tl_2_title: '采访美国财政部长贝森特',
    tl_2_preview: '在吉隆坡中美贸易谈判期间现场报道，拍摄并发布独家画面和关键外交时刻。',
    tl_2_detail_label: '详情',
    tl_2_d1: '在吉隆坡现场报道中美贸易谈判',
    tl_2_d2: '拍摄 Bessent 财长的独家讲话画面',
    tl_2_d3: '在小红书发布内容，获得 100+ 互动',
    tl_2_d4: '展现在高风险外交环境中的工作能力',
    ...
    tl_4_title: '投资助理 · 海坤投资管理',
    tl_4_preview: '全球市场情报（Bloomberg/SCMP），AI/SaaS 出海项目筛选，Excel 财务数据分析。',
    tl_4_detail_label: '主要职责',
    tl_4_d1: '通过 Bloomberg、SCMP 和金融数据库收集全球市场情报',
    tl_4_d2: 'AI 和 SaaS 出海项目筛选与初步尽职调查',
    tl_4_d3: '使用 Excel 进行财务数据分析与建模',
    tl_4_d4: '为投资委员会准备投资备忘录',
    tl_5_title: '计算机科学 本科',
    tl_5_preview: '班级前 20%。核心课程：计算机组成、软件工程、Java、操作系统、离散数学。GDSC 成员。',
    tl_5_detail_label: '学术亮点',
    tl_5_d1: '计算机科学专业排名前 20%',
    tl_5_d2: '核心课程：计算机组成、软件工程、Java、操作系统、离散数学',
    tl_5_d3: 'Google 开发者学生俱乐部（GDSC）成员',
    tl_5_d4: 'IELTS 阅读 8.0 — 熟练阅读英文金融与学术材料',
    contact_label: '联系',
    contact_title: '取得联系',
